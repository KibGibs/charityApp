...
class DonationController extends BaseController {
	...
	public function paypalDonate() {
		...
		$params = [
			...
			'currency' => 'PHP',
			'returnUrl' => URL::action('DonationController@paypalReturn'),
			'cancelUrl' => URL::action('DonationController@paypalCancel'),
		];
		Session::set('paypal.send.params',$params);
	...
	public function paypalReturn() {
		$params = Session::get('paypal.send.params');
		...
		if(isset($paypalResponse['PAYMENTINFO_0_ACK']) && $paypalResponse['PAYMENTINFO_0_ACK'] === 'Success') { 
				...
				$donation->remarks = $paypalResponse['PAYMENTINFO_0_TRANSACTIONID'];
				if($donation->save()){
